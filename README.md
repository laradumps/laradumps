...
#### Usage
<!--LaraDumpsVersion-->
1. Download the 🖥️ [LaraDumps](https://github.com/laradumps/app) Desktop App here: [Windows](https://github.com/laradumps/app/releases/download/v1.5.1/LaraDumps-Setup-1.5.1.exe) | [MacOS](https://github.com/laradumps/app/releases/download/v1.5.1/LaraDumps-1.5.1.dmg)
