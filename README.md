...
1. Download the 🖥️ [LaraDumps](https://github.com/laradumps/app) Desktop App, choose your OS: [Windows](https://github.com/laradumps/app/releases/download/v1.2.0/LaraDumps-Setup-1.2.0.exe) | [MacOS](https://github.com/laradumps/app/releases/download/v1.2.0/LaraDumps-1.2.0.dmg)
